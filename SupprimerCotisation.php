...
<table class="table caption-top">
  ...
  <tbody>
    ...
    <td><?= $cotisation['Prenom']?></td>
      ...
      <td><a href="SupprimerCotisation.php?NumCotis=<?= $cotisation['NumCotis']?>">Supprimer</a></td>
    </tr>
    <?php
    }
    ?> 
...
<p class="panel-heading">SUPPRIMER PAIEMENT</p>

<form  method="post" action="SupprimerCotisation.php">
<div class="md-form">
      ...
      <option value="Inscription">Inscription</option>
                    ...
                    <label for="montant">Montant</label>
                      ...
                      <div class="text-center mt-4">
                        <button type="submit" name="valider" class="btn btn-success"  value="valider">Supprimer</button>
...
<?php 
 ...
 if(!empty($_POST['datecotise']) AND !empty($_POST['Numco']) AND !empty($_POST['mois']) AND !empty($_POST['motif']) AND !empty($_POST['matricule']));
                ...
                $sql = "DELETE FROM cotisation   WHERE NumCotis=?";
